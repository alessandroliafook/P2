...
public class Noob extends Usuario {
	...
	/**
	 * Realiza a construcao de um objeto do tipo Noob, que eh subclasse de
	 ...
	 */
	public Noob(String nome, String login, double saldo, int x2p, HashSet<Jogo> jogos) throws Exception {
	...
	public boolean compraJogo(Jogo jogo) throws Exception {
		...
		if (jogo.getPreco() > super.getSaldo()) {
			...
			int X2P = Math.round((float) jogo.getPreco() * 10);
	...
	public String toString() {
		...
		String enter = "\n";
		String string = getLogin() + enter + getNome() + " - Jogador Noob" + enter + super.toString();
