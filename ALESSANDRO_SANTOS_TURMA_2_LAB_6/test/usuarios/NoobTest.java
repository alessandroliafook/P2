...
public class NoobTest {
	...
	public void testNoob() {
		...
		try {
			...
			Usuario alfs = new Noob("Alessandro fook", "alfs");
		...
		try {
			...
			Usuario usuarioInvalido = new Noob("", "alfs");
		...
		try {
			...
			Usuario usuarioInvalido = new Noob(null, "alfs");
			fail("Deve lancar excecao.");
		...
		try {
			...
			Usuario usuarioInvalido = new Noob("Alessandro", " ");
			fail("Deve lancar excecao.");
	...
	public void testToString() {
		...
		String enter = "\n";
		String mensagem = "alfs" + enter + "Alessandro fook - Jogador Noob" + enter + "+ Street Fighter - Luta:" + enter
