...
public class Plataforma extends Jogo {
	...
	/**
	 * Realiza a construcao de um objeto do tipo Plataforma, que eh subclasse de
	 * jogo, considerando que neste momento o jogo nao foi jogado nenhuma vez,
	 * logo, o numero de jogadas, conclusoes ou score inicia como o valor 0.
	 * 
	 * @param nome
	 ...
	 */
	public Plataforma(String nome, double preco, HashSet<Jogabilidade> estilo) throws Exception {
	...
	public String toString() {
		...
		String enter = "\n";
		String mensagem = "+ " + getNome() + " - Plataforma:" + enter + super.toString(); 
