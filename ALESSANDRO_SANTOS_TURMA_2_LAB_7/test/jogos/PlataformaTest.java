...
public class PlataformaTest {
	...
	public void PlataformaTest() {
		...
		try {
			...
			Jogo jogoInvalido = new Plataforma(nomeInvalido, 30, jogabilidade);
		...
		try {
			...
			Jogo jogoInvalido = new Plataforma(nomeInvalido, 15, jogabilidade);
			fail("Se chegar aqui esta errado, pois deve lancar excecao.");
		} catch (Exception e) {
		...
		try {
			...
			Jogo jogoInvalido = new Plataforma("Super Mario World", -1, jogabilidade);
			fail("Se chegar aqui esta errado, pois deve lancar excecao.");
		} catch (Exception e) {
		...
		try {
			...
			jogabilidade = null;
			Jogo jogoInvalido = new Plataforma("Super Mario World", 0, jogabilidade);
			fail("Se chegar aqui esta errado, pois deve lancar excecao.");
		} catch (Exception e) {
